...
| **E3** | The Quipu — physical necklace | 🟡 **mostly** (step model + codec + guide built this round; only the Emerald colour VALUES pending) | **F57**; distinct from F27 day-chips | remaining: confirm colour values from the Emerald table (external), then render the necklace (**E4/F58-F59**) | 1 (shipped, colours provisional) |
